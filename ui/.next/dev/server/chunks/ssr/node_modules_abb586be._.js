...
"[project]/node_modules/convex-helpers/index.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@convex-dev/better-auth/dist/plugins/convex/index.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$convex$2d$helpers$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/convex-helpers/index.js [app-rsc] (ecmascript)");
;
;
;
...
const convex = (opts)=>{
    ...
    const oidcProvider = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$plugins$2f$oidc$2d$provider$2f$index$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["oidcProvider"])({
        loginPage: "/not-used",
        metadata: {
        ...
        jwt: {
            ...
            definePayload: ({ user, session })=>({
                    ...opts.jwt?.definePayload ? opts.jwt.definePayload({
                        user,
                        session
                    }) : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$convex$2d$helpers$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["omit"])(user, [
                        "id",
                        "image"
                    ]),
    ...
    const jwt = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$plugins$2f$jwt$2f$index$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$locals$3e$__["jwt"])({
        ...jwtOptions,
        adapter: {
    ...
    const bearer = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$plugins$2f$bearer$2f$index$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["bearer"])();
    const schema = {
        user: {
            fields: {
                userId: {
    ...
    return {
        ...
        endpoints: {
            getOpenIdConfig: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$better$2d$auth$2f$core$2f$dist$2f$api$2f$index$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["createAuthEndpoint"])("/convex/.well-known/openid-configuration", {
                method: "GET",
                metadata: {
                    isAction: false
                }
            ...
            getJwks: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$better$2d$auth$2f$core$2f$dist$2f$api$2f$index$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["createAuthEndpoint"])("/convex/jwks", {
                method: "GET",
                metadata: {
                    openapi: {
            ...
            getLatestJwks: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$better$2d$auth$2f$core$2f$dist$2f$api$2f$index$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["createAuthEndpoint"])(// This path is inaccessible due to SERVER_ONLY: true, it's here to
            ...
            "/convex/latest-jwks", {
                ...
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$plugins$2f$jwt$2f$index$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$locals$3e$__["jwt"])(jwtOptions).endpoints.getJwks({
                    ...ctx,
                    method: "GET"
                });
            ...
            rotateKeys: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$better$2d$auth$2f$core$2f$dist$2f$api$2f$index$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["createAuthEndpoint"])(// This path is inaccessible due to SERVER_ONLY: true, it's here to
            // avoid errors that occur in all matchers when path is undefined.
            "/convex/rotate-keys", {
                isAction: true,
                method: "POST",
            ...
            getToken: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$better$2d$auth$2f$core$2f$dist$2f$api$2f$index$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["createAuthEndpoint"])("/convex/token", {
                method: "GET",
                requireHeaders: true,
                use: [
...
"[project]/node_modules/@convex-dev/better-auth/dist/utils/index.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const getToken = async (siteUrl, headers, opts)=>{
    const fetchToken = async ()=>{
        const { data } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$better$2d$fetch$2f$fetch$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["betterFetch"])("/api/auth/convex/token", {
            baseURL: siteUrl,
            headers
        });
        return {
    ...
    const token = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$cookies$2f$index$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getSessionCookie"])(new Headers(headers), {
        cookieName: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$convex$2d$dev$2f$better$2d$auth$2f$dist$2f$plugins$2f$convex$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["JWT_COOKIE_NAME"],
    ...
    try {
        const claims = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jose$2f$dist$2f$webapi$2f$util$2f$decode_jwt$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["decodeJwt"](token);
...
"[project]/node_modules/@convex-dev/better-auth/dist/nextjs/index.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$common$2d$tags$2f$es$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/common-tags/es/index.js [app-rsc] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$common$2d$tags$2f$es$2f$stripIndent$2f$stripIndent$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$export__default__as__stripIndent$3e$__ = __turbopack_context__.i("[project]/node_modules/common-tags/es/stripIndent/stripIndent.js [app-rsc] (ecmascript) <export default as stripIndent>");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/rsc/react.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$convex$2d$dev$2f$better$2d$auth$2f$dist$2f$utils$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@convex-dev/better-auth/dist/utils/index.js [app-rsc] (ecmascript)");
;
;
;
;
// Caching supported for React 19+ only
const cache = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].cache || ((fn)=>{
    return (...args)=>fn(...args);
});
const parseConvexSiteUrl = (url)=>{
    if (!url) {
        throw new Error(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$common$2d$tags$2f$es$2f$stripIndent$2f$stripIndent$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$export__default__as__stripIndent$3e$__["stripIndent"]`
...
const convexBetterAuthNextJs = (opts)=>{
    ...
    const cachedGetToken = cache(async ({ forceRefresh } = {})=>{
        const headers = await (await __turbopack_context__.A("[project]/node_modules/next/headers.js [app-rsc] (ecmascript, async loader)")).headers();
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$convex$2d$dev$2f$better$2d$auth$2f$dist$2f$utils$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getToken"])(siteUrl, headers, {
            ...opts,
            forceRefresh
        });
    });
    ...
    return {
        ...
        preloadAuthQuery: async (query, ...args)=>{
            return callWithToken((token)=>{
                ...
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$convex$2f$dist$2f$esm$2f$nextjs$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["preloadQuery"])(query, ...argsAndOptions);
            });
        },
        fetchAuthQuery: async (query, ...args)=>{
            return callWithToken((token)=>{
                const argsAndOptions = getArgsAndOptions(args, token);
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$convex$2f$dist$2f$esm$2f$nextjs$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["fetchQuery"])(query, ...argsAndOptions);
            });
        },
        fetchAuthMutation: async (mutation, ...args)=>{
            return callWithToken((token)=>{
                const argsAndOptions = getArgsAndOptions(args, token);
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$convex$2f$dist$2f$esm$2f$nextjs$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["fetchMutation"])(mutation, ...argsAndOptions);
            });
        },
        fetchAuthAction: async (action, ...args)=>{
            return callWithToken((token)=>{
                const argsAndOptions = getArgsAndOptions(args, token);
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$convex$2f$dist$2f$esm$2f$nextjs$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["fetchAction"])(action, ...argsAndOptions);
            });
        }
    };
}; //# sourceMappingURL=index.js.map
...
//# sourceMappingURL=node_modules_abb586be._.js.map